    ...
    if (!class_exists('DOPBSPBackEndCalendar')){
        class DOPBSPBackEndCalendar extends DOPBSPBackEndCalendars{
            ...
            function setAvailable($id){
                ...
                if($wpdb->num_rows > 0) {
                    $default_availability = $calendar_data->default_availability != '' ? $calendar_data->default_availability:'{"available": "",
                                                                                                                               "bind": 0,
                                                                                                                               "price": 0,
                                                                                                                               "promo": 0,
                                                                                                                               "info":  "",
                    ...
                    $min_available = ($default_availability->available > 0 && $default_availability->status != 'booked' && $default_availability->status != 'unavailable' && $default_availability->status != 'none') ?  $default_availability->available:0;
                } 
