    ...
    if (!class_exists('DOPBSPBackEndCalendarAvailability')){
        class DOPBSPBackEndCalendarAvailability extends DOPBSPBackEndCalendar{
            ...
            function setDays($id,
                ...
                $default_availability = $calendar->default_availability != '' ? $calendar->default_availability:'{"available": "",
                                                                                                                   "bind": 0,
                                                                                                                   "price": 0,
                                                                                                                   "promo": 0,
                                                                                                                   "info":  "",
...
//                        $day_split = explode('-',$days_data[$day]['day']);
                        ...
                        $days_data[$day]->min_available = $default_availability->available == '' && ($default_availability->status != 'booked' && $default_availability->status != 'none' && $default_availability->status != 'unavailable') ? ($default_availability->available == '' ? 0:(float)$default_availability->available):(float)$default_availability->available;
                ...
                foreach ($days_data as $day):
                    ...
                    if ($day_data->status == 'available' 
                         ...
                         */
                        if (count($days_available) > 0
                            && isset($days_available[$day->day])){
...
//                                if($day->day == '2017-07-27') {
//                                    echo '<pre>';
//                                    print_r($days_available); exit;
//                                }
