        ...
        methods_month = {
             ...
             */    
                ...
                for (i=1; i<=noDays; i++){
                    ...
                    cmonth = DOPPrototypes.getLeadingZero(d.getMonth()+1);
                    cday = DOPPrototypes.getLeadingZero(d.getDate());
                    day = schedule[cyear+'-'+cmonth+'-'+cday] !== undefined && schedule[cyear+'-'+cmonth+'-'+cday] !== null ? schedule[cyear+'-'+cmonth+'-'+cday]:methods_day.default(DOPPrototypes.getWeekDay(cyear+'-'+cmonth+'-'+cday));
        ...
        methods_days = {
                ...
                if (methods_search.days.validate(ciDay) 
                    ...
                    for (i=0; i<selectedDays.length-(methods_days.data['morningCheckOut'] ? 1:0); i++){
                        ...
                        if (!dayFound){
                            ...
                            if(default_schedule['status'] === 'unavailable' 
                              || default_schedule['status'] === 'booked'
                              || (schedule[currDay] !== undefined 
                                  && (schedule[currDay]['status'] === 'unavailable'
                                     || schedule[currDay]['status'] === 'booked'))) {
                                methods_info.toggleMessages(DOPBSPFrontEnd.text(ID, 'search', 'noServices'));
                                return false;
                            }
                        }
                    ...
                    for (i=0; i<selectedDays.length-(methods_days.data['morningCheckOut'] ? 1:0); i++){
                        ...
                        if (schedule[currDay] === undefined || 
                            ...
                            if(default_schedule === undefined ||
                                default_schedule['available'] === '') {
                                noAvailable = 1;
                            } 
                            else if (noAvailable > default_schedule['available']){
             ...
             */
                ...
                for (i=0; i<selectedDays.length-(methods_days.data['morningCheckOut'] ? 1:0); i++){
                    ...
                    history[currDay]['available'] = schedule[currDay] !== undefined ? schedule[currDay]['available']:default_schedule['available'];
                    history[currDay]['bind'] = schedule[currDay] !== undefined ? schedule[currDay]['bind']:default_schedule['bind'];
                    history[currDay]['price'] = schedule[currDay] !== undefined ? schedule[currDay]['price']:default_schedule['price'];
                    history[currDay]['promo'] = schedule[currDay] !== undefined ? schedule[currDay]['promo']:default_schedule['promo'];
                    history[currDay]['status'] = schedule[currDay] !== undefined ? schedule[currDay]['status']:default_schedule['status'];
                }
                ...
                if(methods_hours.data['enabled'] 
                   && methods_hours.data['interval_autobreak']) {
                    ...
                    if (methods_schedule.vars.schedule[id.split('_')[1]] !== undefined){
                        ...
                        // Count available
                        if (default_schedule !== undefined){
                            var hours = default_schedule['hours'];
                            available = 0;
                            var i = 0;
             ...
             */
                ...
                if (methods_search.days.validate(day) 
                    ...
                    if ((schedule[day] !== undefined 
                       ...
                       || (default_schedule['hours'] !== undefined
                        ...
                        if(default_schedule['hours'][selectedHours[0]]['status'] === 'unavailable' 
                          ...
                          || (schedule[day] !== undefined 
                              && schedule[day]['hours'] !== undefined 
                              && schedule[day]['hours'][selectedHours[0]] !== undefined 
                              && (schedule[day]['hours'][selectedHours[0]]['status'] === 'unavailable'
                                 || schedule[day]['hours'][selectedHours[0]]['status'] === 'booked'))) {
                            methods_info.toggleMessages(DOPBSPFrontEnd.text(ID, 'search', 'noServices'));
                            return false;
                        }
                    }
                    ...
                    for (i=0; i<selectedHours.length-hoursDiff; i++){
                        ...
                        if (!hourFound){
                            ...
                            if(default_schedule['hours'][currHour] === undefined
                               || (default_schedule['hours'][currHour]['status'] === 'unavailable' 
                    ...
                    if (!methods_search.days.validate(day)
                        ...
                        if(default_schedule['status'] === 'unavailable' 
                              || default_schedule['status'] === 'booked'
                              || (methods_search.days.validate(day) 
                                  && default_schedule['status'] === 'none'
                                    && schedule[day] === undefined)
                              || (schedule[day] !== undefined 
                                  && (schedule[day]['status'] === 'unavailable'
                                     || schedule[day]['status'] === 'booked'))) {
                            methods_info.toggleMessages(DOPBSPFrontEnd.text(ID, 'search', 'noServices'));
                            return false;
                        }
                    }
