...
class wpdevart_bc_calendar{
	...
	**/
	...
	public function wpdevart_ajax() {
		...
		$id = isset($_POST['wpdevart_id']) ? esc_html($_POST['wpdevart_id']) : 0;
	...
	public function wpdevart_add_field() {
		...
		$max_id = isset( $_POST['wpdevart_field_max'] ) ? esc_html( $_POST['wpdevart_field_max']) : 0;
		$count =  isset( $_POST['wpdevart_field_count'] )  ? esc_html( $_POST['wpdevart_field_count']) : 0;
		$args =  array(
	...
	public function wpdevart_add_extra_field() {
		$max_id =  isset( $_POST['wpdevart_extra_field_max'] )  ? esc_html( $_POST['wpdevart_extra_field_max']) : 0;
		$count = isset( $_POST['wpdevart_extra_field_count'] )  ? esc_html( $_POST['wpdevart_extra_field_count']) : 0;
		$args =  array(
	...
	public function wpdevart_add_extra_field_item() {
		$max_id = isset( $_POST['wpdevart_extra_field_item_max'] ) ? esc_html( $_POST['wpdevart_extra_field_item_max']) : 0;
		if ( isset( $_POST['wpdevart_extra_field'] ) ) {
			$extra_field = esc_html( $_POST['wpdevart_extra_field']);
		}
		$count = isset( $_POST['wpdevart_extra_field_item_count'] ) ? esc_html( $_POST['wpdevart_extra_field_item_count']) : 0;
